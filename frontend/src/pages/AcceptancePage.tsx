    ...
    <div className="min-h-screen bg-slate-50 pt-28 pb-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl px-5 py-3 inline-flex items-center gap-2 text-sm text-amber-700">
            <span className="font-semibold">📋 Check your acceptance status in your</span>
            <Link to="/author-dashboard" className="font-bold underline hover:text-amber-900">Author Dashboard →</Link>
          </div>
        </div>
