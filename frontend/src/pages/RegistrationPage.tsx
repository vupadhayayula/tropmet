    ...
    <div className="min-h-screen bg-stone-50 pt-28 pb-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="font-display text-4xl font-bold text-[#0b2d5e] mb-2">Conference Registration & Payment</h1>
          <p className="text-slate-500 text-sm mb-3">Complete your conference registration after your abstract is accepted.</p>
          <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-xl px-4 py-2 text-xs text-amber-700 font-medium">
            ⚠️ Accepted authors should register via their <a href="/author-dashboard" className="font-bold underline">Author Dashboard</a> — payment is linked to your paper ID automatically.
          </div>
