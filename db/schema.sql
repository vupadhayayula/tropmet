...
-- ─────────────────────────────────────────────────────────────
-- SCHEMA UPDATE v10: Add email verification support
-- These fields support the email verification flow in auth.py
-- (The _pending_verifications dict handles this in-memory for now;
--  for production, store tokens in this table instead)
-- ─────────────────────────────────────────────────────────────

-- Email verification tokens (for production persistence)
CREATE TABLE IF NOT EXISTS email_verification_tokens (
    id         INT AUTO_INCREMENT PRIMARY KEY,
    email      VARCHAR(255) NOT NULL,
    token      VARCHAR(128) NOT NULL UNIQUE,
    user_data  TEXT,            -- JSON of pending user data
...
-- ── SMTP Configuration in .env (add these) ────────────────────
-- SMTP_HOST=smtp.gmail.com
-- SMTP_PORT=587
-- SMTP_USER=your-email@gmail.com
-- SMTP_PASS=your-app-password
-- (If not set, verification tokens are printed to the server console)
